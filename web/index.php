...
<script> 
    ...
    const previousChoicesString = <?php echo json_encode($prevChoices, JSON_FORCE_OBJECT)?>;
    console.log(previousChoicesString, typeof(previousChoicesString));
    const previousChoices = JSON.parse(previousChoicesString);
